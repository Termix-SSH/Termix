...
import { TOTPSetup } from "@/user/TOTPSetup.tsx";
import {
  getUserInfo,
  getVersionInfo,
  deleteAccount,
...
import { PasswordReset } from "@/user/PasswordReset.tsx";
import { useTranslation } from "react-i18next";
import { LanguageSwitcher } from "@/user/LanguageSwitcher.tsx";
import { useSidebar } from "@/components/sidebar.tsx";
import { toast } from "sonner";
import { C2STunnelPresetManager } from "@/user/C2STunnelPresetManager.tsx";
                ...
                <TabsContent value="appearance" className="space-y-4">
                  ...
                  <div className="rounded-lg border-2 border-edge bg-elevated p-4">
                    ...
                    <div className="space-y-6">
                      ...
                      {/* Accent color */}
                      <div>
                        <Label className="text-foreground-secondary mb-2 block">
                          ...
                          {ACCENT_PRESET_COLORS.map((c) => (
                            <button
                              ...
                              onClick={() => {
                                ...
                                setCustomAccentColor(c.value);
                                localStorage.setItem("termix-accent", c.value);
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <input
                            ...
                            onBlur={(e) => {
                              ...
                              setAccentColor(val);
                              localStorage.setItem("termix-accent", val);
