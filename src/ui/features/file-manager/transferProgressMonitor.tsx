...
export function showTransferCompletionToast(
  ...
  showDefaultCompletionToast(finalStatus, toastId ?? `transfer-done-${finalStatus.transferId}`, t, formatTransferMetrics);
...
function showCancelledTransferToast(
  ...
  const showCleanupAction =
    hasPartialDest && !finalStatus.cleanupCompleted;
