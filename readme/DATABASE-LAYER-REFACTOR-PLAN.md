...
host health, and host metrics preference/history current repository factories
now share `current-repository-runtime` for SQLite context and write-save hooks.
