 ...
 * ids are new and never enter the `enabledWidgets` host setting.
 */
 ...
 * the `enabledWidgets` host setting valid for the mobile app.
 */
 ...
 * current the `enabledWidgets` host setting), preserving canonical order. Manager
