 ...
 * Used to stop metrics polls from stampeding under load.
 */
...
/**
 * The first heavy SSH sample waits until core's cheap status check says the
...
export function createMetricsState() {
  return {
    ...
    initialLimiter: new ConcurrentLimiter(2),
    hostCache: new HostPollCache(30_000),
...
export type MetricsState = ReturnType<typeof createMetricsState>;
