...
vi.mock("../../../../../src/backend/utils/proxy-agent.js", () => ({
  fetchWithProxy,
  getFetchDispatcher,
}));
vi.mock("../../../../../src/backend/utils/safe-outbound-fetch.js", () => ({
  safeOutboundFetch,
}));
vi.mock("../../../src/backend/egress.js", () => ({
  readPrivateAllowlist,
  evaluateEgress,
}));

const { providerFetch } =
  await import("../../../src/backend/providers/http.js");
