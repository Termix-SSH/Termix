...
// Copy of src/ui/lib/useConnectionRetry.ts. Duplicated here rather than
// exposed through the SDK because only this plugin's Proxmox stats tab uses
// it today; promote to @termix/plugin-sdk/ui once a second plugin needs it.
