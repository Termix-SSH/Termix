...
import {
  ...
  verifyOIDCToken,
} from "../../src/backend/oidc-protocol.js";
import {
  getOidcConfigFromEnv as getOIDCConfigFromEnv,
  isEnvOverrideEnabled as isOIDCEnvOverrideEnabled,
} from "../../src/backend/providers.js";
...
const oidcUtils = await import("../../src/backend/oidc-protocol.js");
