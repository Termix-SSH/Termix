...
vi.mock("../../../../src/backend/hosts/metrics-shared/common-utils.js", () => ({
  execCommand: vi.fn(async () => ({ stdout: "ok", stderr: "", code: 0 })),
}));

vi.mock("../../../../src/backend/hosts/metrics-shared/platform.js", () => ({
...
vi.mock(
  "../../../../src/backend/hosts/metrics-shared/package-commands.js",
  () => ({
    buildPackageActionCommand: vi.fn(() => "apt-get install -y foo"),
  }),
);

vi.mock("../../../../src/backend/hosts/metrics-shared/validation.js", () => ({
  isValidPackageName: (v: unknown) => typeof v === "string" && v.length > 0,
}));

vi.mock(
  "../../../../src/backend/database/routes/snippets-execution.js",
  () => ({
    resolveSnippetCommand: (command: string) => command,
  }),
);

vi.mock("../../../../src/backend/database/routes/rbac.js", () => ({
...
vi.mock("../../../../src/backend/database/routes/fleet-dispatch.js", () => ({
...
describe("POST /:id/packages", () => {
  ...
  it("surfaces an ElevationError as a per-host error, not a request failure", async () => {
    const { execElevated, ElevationError } =
      await import("../../../../src/backend/hosts/metrics-shared/exec-elevated.js");
