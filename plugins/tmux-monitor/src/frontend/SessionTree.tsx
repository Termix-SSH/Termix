                ...
                <span className="pointer-events-none z-10 col-start-1 row-start-1 flex items-center gap-1.5 justify-self-end opacity-0 transition-opacity group-focus-within:pointer-events-auto group-focus-within:opacity-100 group-hover:pointer-events-auto group-hover:opacity-100">
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      <button
                        className="-m-1 p-1 text-muted-foreground hover:text-foreground data-[state=open]:text-foreground"
              ...
              session.windows.map((win) => {
                ...
                return (
                  <div key={win.index} className="ml-4">
                    <div
                      className="group flex cursor-pointer items-center gap-1 px-2 py-0.5 text-xs text-muted-foreground hover:bg-muted/40"
                    ...
                    >
                      ...
                      <button
                        className="-m-1 ml-auto shrink-0 p-1 text-muted-foreground opacity-0 transition-opacity hover:text-destructive focus-visible:opacity-100 group-hover:opacity-100"
                    ...
                    {!winCollapsed &&
                      win.panes.map((pane) => {
                        ...
                        return (
                          <div
                            key={pane.id}
                            className={`group ml-5 flex cursor-pointer items-center gap-1.5 px-2 py-1 text-xs hover:bg-muted/40 ${isSelected ? "bg-accent-brand/10" : ""}`}
                            onClick={() =>
                              onSelectPane({
                                paneId: pane.id,
