...
ALTER TABLE `ssh_data` ADD `status_check_enabled` integer DEFAULT true NOT NULL;--> statement-breakpoint
ALTER TABLE `ssh_data` ADD `status_check_interval` integer;